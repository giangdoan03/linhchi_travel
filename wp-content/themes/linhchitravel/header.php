            ...
            <div class="pt-3 pb-3 w-100 menu_top_bar_w">
                <div class="row">
                    <div class="col-2 site-branding">
                        ...
                        ?>
                        <!-- Nút mở menu -->
                        <button class="navbar-toggler" type="button" aria-controls="primary-menu" aria-expanded="false" aria-label="Toggle navigation">
                            <i class="bi bi-list" id="menu-icon"></i> <!-- Icon Bootstrap -->
                        </button>

                    </div>

                    <div class="col-12 col-md-10 no-pd-menu-mobile">
                        <!-- Bootstrap Navbar -->
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <div class="container-fluid">
                                <div class="collapse navbar-collapse" id="primary-menu">
                                    <?php
                                    wp_nav_menu(array(
                                        'theme_location'  => 'menu-1', // Vị trí menu (đăng ký trong functions.php)
                                        'menu_class'      => 'menu', // Class CSS cho <ul>
                                        'container'       => 'nav', // Thẻ bao bọc
                                        'container_class' => 'menu-container', // Class CSS cho container
                                        'fallback_cb'     => false, // Không hiển thị gì nếu không có menu
                                        'depth'           => 3, // Hỗ trợ menu đa cấp (3 cấp)
                                    ));
                                    ?>
                                </div>
                            </div>
